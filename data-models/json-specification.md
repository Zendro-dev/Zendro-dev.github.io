...
The following types are allowed for the attributes field. Each also has an array form (e.g. `[String]`, `[Int]`) for attributes holding a list of values — for example, `river`'s `country_ids: [String]` in the [GraphQL basics]({% link guides/graphql-basics.md %}) guide's demo data model:
