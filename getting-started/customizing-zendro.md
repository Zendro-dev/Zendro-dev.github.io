...
3. Create a sandbox with the [Zendro CLI](https://github.com/Zendro-dev/zendro#a-quick-example-for-setting-up-a-zendro-sandbox). Follow steps 1-3 on that page.
