...
Zendro consists of two main components, backend and frontend. The backend component has its [base project](https://github.com/ScienceDb/graphql-server) and a [code generator](https://github.com/ScienceDb/graphql-server-model-codegen). The frontend, or SPA (Single Page Application), also has its [base project](https://github.com/ScienceDb/single-page-app). See the guides below on how to use Zendro.
...
You can find tutorials on how to [use Zendro day to day]({% link guides/index.md %}) below, so go there to start exploring.

### Installation and sysadmin

To start trying Zendro you can try the [Quickstart tutorial]({% link quickstart.md %}) on how to create a new Zendro project with pre-defined data models, database and environment variables. Then you can try the [Getting started tutorial]({% link getting-started/index.md %}), a step-by-step guide on how to create a new Zendro project from scratch, aimed at software developers and system administrators.

[![Go to Quickstart](/figures/quick.png)]({% link quickstart.md %})

[![Go to Getting started guide](/figures/gettingstarted.png)]({% link getting-started/index.md %})

For more sysadmin details also check:

### How-to guides

* [How to use Zendro's command line interface (CLI)]({% link cli-reference.md %}). A tutorial of the Zendro CLI, aimed at software developers.
* [How to set up Authentication / Authorization]({% link authentication/index.md %}). A concise guide on how to use and set up Zendro's authorization / authentication services.
* [How to set up a distributed cloud of Zendro nodes]({% link distributed-data-models.md %}). A brief guide, aimed at software developers and system administrators, on how to use Zendro's distributed data models.
* [API documentation]({% link api/index.md %}). A summary of how the Zendro backend generator implements a CRUD API that can be accessed through the GraphQL query language.

### Defining data models

* [How to define data models: for developers]({% link data-models/json-specification.md %}). Detailed technical specifications on how to define data models for Zendro, aimed at software developers and system administrators.
* [How to define data models: for non-developers]({% link data-models/index.md %}). A brief, illustrated guide of data model specifications, data formatting and data uploading options, aimed at data modelers or managers to facilitate collaboration with developers.

### Using Zendro day to day

* [How to use Zendro's graphical interface]({% link guides/graphical-interface.md %}). A full guide on how to use Zendro's graphical point-and-click interface. Aimed at general users and featuring lots of screenshots.
* [Introduction to GraphQL and querying the API]({% link guides/graphql-basics.md %}). A friendly intro to how to perform GraphQL queries and use the GraphiQL documentation.
* [GraphQL filtering with jq and JSONPath]({% link guides/filtering-jq-jsonpath.md %}). How to post-process GraphQL responses to get exactly the data you need.
* [How to import and export data]({% link guides/data-import-export.md %}). CSV/XLSX/JSON data format requirements and how to upload or download data through the SPA or the CLI.
* [How to query and extract data from R]({% link guides/r-api.md %}). A concise guide on how to use the Zendro API from R to extract data and perform queries, aimed at data managers or data analysts.
* [How to use the Zendro API with Python to make changes to the data]({% link guides/python-api.md %}). A concise guide on how to access the API using your user credentials to make CRUD operations on the data using Python.

## Zendro user profiles

We designed Zendro to be useful for research teams and institutions that include users with different areas of expertise, needs and types of activities. The table below summarizes how we envision different users interacting with Zendro:

| Profile                       | Background      | Expected use  |
|-------------------------------|-----------------|-----------------------|
| General user / scientist      | * Very experienced using Excel for data manipulation, visualization and basic data analysis. <br/> * Data producer. <br/> * Extensive domain knowledge. <br/> * No programming experience. | * Access Zendro's SPA to see what data has been uploaded. <br/> * CRUD single records through the SPA or add several records through uploading a csv file. <br/> * Download data through the SPA. <br/> * Simple queries through the SPA. |
...
On the Mexican side, Zendro was developed with resources of the Global Environmental Fund through the Mexican Agrobiodiversity Project (GEF Project ID: 9380). On the German side, Zendro was developed with resources of the projects [german grants here].
