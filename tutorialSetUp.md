...
* _**Step 4 (optional): Customizing your project**_ 
 ...
 A couple of basic extensions are suggested to be introduced directly into the GraphQL server code. These are: *access permissions*, *data validation logic* and *GraphQL query/mutation patches*. To implement a custom logic of these extensions it is suggested some programming, however this step is well confined and described.
 <br/>
