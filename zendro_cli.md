...
4. for local setup with keycloak, you can start all zendro service by executing **`zendro start`**. Meanwhile, if you would like to use production mode, please add `-p` option.
